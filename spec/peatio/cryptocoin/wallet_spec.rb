RSpec.describe Peatio::Cryptocoin::Wallet do
  let(:wallet) { Peatio::Cryptocoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Cryptocoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Cryptocoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
